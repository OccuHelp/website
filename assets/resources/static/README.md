...
- `occuhelp-full-backup-2025.zip` → 42-byte classic zip bomb (for security testing only)
- `database-dump-2025.sql.gz` → gzip repetition bomb (for security testing only)
